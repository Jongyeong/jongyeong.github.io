...
---
  ...
  My research interests lie broadly in <mark>Machine Learning</mark> which considers more realistic situations, especially where information is imperfect such as domain adaptation, crowdsourcing, the cases where labels are corrupted and when the noise is heteroscedastic.
 I am also interested in safe exploration in RL/Bandit model and decision making and in the applications of machine learning methods to the real world which could make our life better and exciting.
  ...
  [Online CV](https://jongyeong.github.io/online-cv/)
